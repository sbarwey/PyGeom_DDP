...
class TopkMultiscaleGNN_MOD(torch.nn.Module):
    """
    max_level_mmp_down: the number of levels in a single mmp layer in downward pass
    max_level_mmp_up: the number of levels in a single mmp layer in upward pass
    ...
    def __init__(self, 
                 ...
                 max_level_mmp_down: int, 
                 max_level_mmp_up: int, 
                 l_char: float,
                 max_level_topk: int,
                 rf_topk: int,
        ...
        self.max_level_mmp_down = max_level_mmp_down
        self.max_level_mmp_up = max_level_mmp_up
        self.l_char = l_char
            ...
            for j in range(self.n_mmp_layers):
                mmp.append(
                            MultiscaleMessagePassingLayer(
                                ...
                                max_level = self.max_level_mmp_down,
                                l_char = self.l_char
                              )   
                           )
            ...
            for j in range(self.n_mmp_layers):
                mmp.append(
                            MultiscaleMessagePassingLayer(
                                ...
                                n_mlp_hidden_layers = self.n_mlp_hidden_layers,
                                n_messagePassing_layers = self.n_messagePassing_layers, 
                                max_level = self.max_level_mmp_up,
                                l_char = self.l_char
                              )   
                           )
    ...
    def input_dict(self) -> dict:
        a = {'input_node_channels': self.input_node_channels,
             ...
             'n_messagePassing_layers': self.n_messagePassing_layers,
             'max_level_mmp_down': self.max_level_mmp_down,
             'max_level_mmp_up': self.max_level_mmp_up,
             'l_char': self.l_char, 
